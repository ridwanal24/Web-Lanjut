			...
			<div class="col-md-10 bg-light shadow rounded">
				...
				<form method="get">
					<div class="form-row mt-4">
						...
						<div class="col-md-2">
							<center><input type="submit" class="btn btn-primary" name="submit" value="Tampilkan"></center>
						</div>
					</div>
				</form>
						...
						if (/*isset($_GET['submit'])&& */isset($_GET['kelas']) AND isset($_GET['jurusan'])) {
							...
							while ($result=mysql_fetch_array($show)) {
								...
								<a href="profil_siswa.php"><tr>
									...
									$nis=$result['nis'];
									?>
									<a class="btn btn-primary text-light" href="profile_siswa.php?nis=<?php echo $nis;?>&kelas=<?php echo $_GET['kelas'];?>&jurusan=<?php echo $_GET['jurusan'];?>">Lihat Profil</a>
								</td>
							</tr></a>		
							<?php
							$nomor++;
