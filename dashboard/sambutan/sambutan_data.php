...
if (empty($_SESSION['username']) AND empty($_SESSION['status'])) {
	...
	<div class="container-fluid">
		...
		<center><h1 class="text-muted">DATA SAMBUTAN</h1></center>
				<br>
				...
				<form action="sambutan_tambah.php">
					...
					<table class="table" >
						<tr class="bg-light">
							...
							$no=0+$posisi;
							$tampil="SELECT idSambutan, judul, deskripsi FROM sambutan limit $posisi, $batas";
							...
							<tr bgcolor="#FFFFFF">
								<td colspan="11">
									<?php
			//hitung jumlah data
									$jml_data = mysql_num_rows(mysql_query("SELECT * FROM sambutan"));
			//Jumlah JmlHalaman
