					...
					<form action="artikel_tambah.php">
						...
						<table class="table" >
							<tr class="bg-light">
								...
								$no=0+$posisi;
								$tampil="SELECT idArtikel, judul as Judul, pathText as Isi, pathImage as Gambar FROM artikel limit $posisi, $batas";
								...
								while ($dataTampil=mysql_fetch_array($qryTampil)) {
									...
									<tr bgcolor="#FFFFFF">
										...
										<td align="center"><?php echo $dataTampil['Gambar']; ?></td>
										<td>
											<div align="center">
